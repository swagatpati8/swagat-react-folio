...
# Lazy-loaded globals — only initialized on first request
_rag_chain = None
...
def get_rag_chain():
    ...
    - Always use Markdown format for links so that they are clickable"
    """
    ...
    _rag_chain = create_retrieval_chain(vectorstore.as_retriever(), question_answer_chain)
    return _rag_chain
